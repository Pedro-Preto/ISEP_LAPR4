...
@Entity
public class BaseForm implements AggregateRoot<BaseFormId> {
    ...
    public BaseForm(BaseFormId id, String name) {
        this.id = id;
        this.name = name;
    ...
    public BaseForm addAttribute(FormAttribute formAttribute) {
